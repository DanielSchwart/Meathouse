...
<div class="login-page">
  <div class="form"  >
<form class="login-form" action="editet.php" onload="resizeIframe(this)" enctype="multipart/form-data" method="post"> 
 <table class="table-login">
          <TR> <TD align="center" height="40pxs">Выбор товара для редактирования</TD></TR>
       </table>
<select class=reg_select required class=edit1 name=edit1 > 
<option disabled selected>Выберите товар</option> 
<?php 
include ("bd.php"); 
$select_sql = "SELECT id, ztext FROM tov"; 
