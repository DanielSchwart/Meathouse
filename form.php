...
<div class="login-page">
  <div class="form"  >
<form class="login-form" action="edit.php" onload="resizeIframe(this)" enctype="multipart/form-data" method="post"> 
 <table class="table-login">
          <TR> <TD align="center" height="40pxs">Выбор новости для редактирования</TD></TR>
       </table>
<select class=reg_select required class=edit1 name=edit1 > 
<option disabled selected>Выберите новость</option> 
<?php 
include ("bd.php"); 
$select_sql = "SELECT id, ztext FROM posts"; 
$result = mysql_query($select_sql); 
$row = mysql_fetch_array($result); 
do 
{ 
echo " <option name='ided' value='{$row['id']}'>{$row['id']}.{$row['ztext']}</option>" ; 
} 
