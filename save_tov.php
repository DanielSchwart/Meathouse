...
$imagep="../".$target_file;
    $result2 = mysql_query ("INSERT INTO tov (ztext,otext,image,date) VALUES('$ztext','$text','$imagep','$today')");
    // Проверяем, есть ли ошибки
    if ($result2=='TRUE')
    {
    echo "МОлодец, ты шо то сделал!";
    $idp=mysql_insert_id();}
...
$data['image'] = $imagep; 
$data['date'] = $today;
$placeholders = array("{1_text}", "{2_text}", "{image}", "{date}"); 
													...
													<div class='row'>
														<div class='col-xs-5'>
															<div class='pagination'>
																<ul>
																	<li><a href='tov-panel.php'>Вернутся к панели добавления товаров</a></li>
