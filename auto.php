					...
					<div class="row">
						<div class="col-md-12">
							<div class="area-title">
								<h3 class="title-group gfont-1">Смена пароля</h3>
							</div>
						</div>
					</div>
					<div class="account-create">
						<form method="post" action=../php/auto-search.php>
							<div class="row">
								<div class="col-md-12">
									<div class="account-create-box">
										<h2 class="box-info">Введите старый пароль</h2>
										<div class="row">
											<div class="col-sm-4 col-xs-12">
												<div class="single-create">
													<p>Пароль<sup>*</sup></p>
													<input class="form-control" type="password" required class=password2 name="passwordA1" size="15" maxlength="15" placeholder="Старый пароль">
												</div>
											</div>																				
										</div>
									</div>
									<div class="account-create-box">
										<h2 class="box-info">Введите новый пароль</h2>
										<div class="row">
											<div class="col-md-4 col-sm-6 col-xs-12">
												<div class="single-create">
													<p>Пароль <sup>*</sup></p>
													<input class="form-control" type="password" required class=password2 name=passwordA2 size="15" maxlength="15" placeholder="Новый пароль">
												</div>
											</div>
									...
									<div class="submit-area">
										...
										<input  type="submit" name="submit2" class=submit2 value="Сменить пароль" class="btn btn-primary floatright"></input>
										<p><p><p><p><p><p><p><p><p><p><p><a href="profile_a.php" class="float-left"><span></span>Вернутся в профиль</a>
